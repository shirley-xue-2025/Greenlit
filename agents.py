...
CHALLENGER_REQUIRED_NL = (
    "Notion had a signed privacy contract but is not a coding tool, so it cannot "
    "prove Replit does not keep our code. Cursor's contract is with Anysphere — "
    "it does not transfer to Replit."
)
